...
<head>
    ...
    <title>Insertion d'EDT</title>
</head>

<body>
    <div class="main radius animate__animated animate__fadeIn">
        <h1 class="header">Insertion d'EDT</h1>

        <form action="../../../controller/EdtCrud/create.php" method="post">
            <div class="diviser">
                <div class="separation">
                    <input type="hidden" name="id" required>
                    <p>Identifiant de la salle</p>
                    <input type="number" min="1" name="idsalle" required>

                    <p>Désignation de la salle</p>
                    <input type="text" name="design_salle" required>
