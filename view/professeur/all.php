...
<body>
    ...
    <div id="main">
        <div class="sidebar animate__animated animate__fadeIn">
            <a class="animate__animated animate__fadeIn active-tab" href="">Gestion des professeur</a>
        ...
        <div class="main-section animate__animated animate__fadeIn">
            <h2 class="title-card">Tous les professeurs</h2>
            ...
            <div class="section-table animate__animated animate__fadeIn animate__delay-1s">
                <table>
                    ...
                    <?php
                        require("../../controller/ProfesseurCrud/read.php");
                    ?>
